...
ADMIN_LOGIN = 'PythON'        # UserID = 1 is a real user, the main admin, the only user created with system
ADMIN_PASSWORD_HASH = tools.hash_password('Simple is better than complex')
